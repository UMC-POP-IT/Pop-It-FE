        ...
        <div className="flex w-[488px] flex-col items-end gap-[60px]">
          ...
          <div className="flex w-full flex-col items-center gap-[120px]">
            ...
            <div className="flex w-full flex-col gap-3">
              <Button variant="kakao" size="lg" className="h-auto! gap-3 px-[40px]! py-[16px]! text-xl! font-bold!" onClick={() => savePendingAndLogin("kakao", pendingAction)}>
              ...
              <Button variant="google" size="lg" className="h-auto! gap-3 px-[40px]! py-[16px]! text-xl! font-bold! text-google-text!" onClick={() => savePendingAndLogin("google", pendingAction)}>
